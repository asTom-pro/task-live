<div class="modal-bg-black js-modal-bg js-click-modal-close"></div>
<div class="modal-share">
  <p class="text-center text-muted modal-share-lead">共有方法を選んでください</p>
  <ul class="modal-share-items">
    <li class="modal-share-item">
      <div class="modal-share-item-btn js-url-copy">
        <i class="far fa-copy  btn-url-copy"></i>
      </div>
